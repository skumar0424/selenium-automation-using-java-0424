...
public class TestNGListener
		implements IInvokedMethodListener, ITestListener, ISuiteListener, IExecutionListener, IReporter {
	...
	public void afterInvocation(IInvokedMethod method, ITestResult testResult) {
		...
		System.out.println("Done: after invocation of " + method.getTestMethod());
	}
